...
def build_road_network():
    ...
    for u, v, key, data in G.edges(keys=True, data=True):
        ...
        if any(
            zone.lower() in road_name
            for zone in restrictions["rodizio_municipal"]["affected_area"]["boundaries"]
        ):
    ...
    with open("data/output/road_network.pkl", "wb") as f:
        pickle.dump(G, f)
